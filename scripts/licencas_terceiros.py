...
NOTAS: list[str] = [
    ...
    "Ao atualizar o servidor, reveja esta seção.",
    "As fontes em `static/fonts/` (Zen Old Mincho, Zen Kaku Gothic New, M PLUS 1 "
    "Code) são vendorizadas do Google Fonts sob a SIL Open Font License 1.1 "
    "(`OFL.txt` junto aos arquivos), não sob a licença do código.",
]
